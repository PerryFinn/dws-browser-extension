...
import {
  ...
  ExpandableContent,
  ExpandableTrigger
} from "@/components/complex-ui/expandable";
            ...
            <ExpandableCardHeader>
              <div className="flex justify-between items-start w-full">
                <div>
                  ...
                  <h3 className="font-semibold text-xl text-gray-800 dark:text-white">Design Sync</h3>
                </div>
                <TooltipProvider>
                  <Tooltip>
            ...
            <ExpandableCardContent>
              ...
              <ExpandableContent preset="blur-md" stagger staggerChildren={0.2}>
                <p className="text-sm text-gray-700 dark:text-gray-200 mb-4">
                  Weekly design sync to discuss ongoing projects, share updates, and address any design-related
                  challenges.
                </p>
                <div className="mb-4">
            ...
            <ExpandableCardContent>
              ...
              >
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4 max-w-xs">
                  Experience crystal-clear audio with our latest noise-cancelling technology. Perfect for work, travel,
                  or relaxation.
                </p>
...
function ControlledExpandableCard() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Expandable expanded={isExpanded} onToggle={handleToggle} expandDirection="vertical" expandBehavior="push">
        <ExpandableCard collapsedSize={{ width: 300, height: 100 }} expandedSize={{ width: 300, height: 300 }}>
          <ExpandableTrigger>
            <ExpandableCardHeader>
